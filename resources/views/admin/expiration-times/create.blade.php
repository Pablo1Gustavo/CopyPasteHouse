...
@section('title', 'Add Expiration Time - CopyPasteHouse')

@section('content')
<div class="max-w-2xl mx-auto px-4 py-6">
    <div class="bg-gray-800 rounded-lg p-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold">Add Expiration Time</h2>
        ...
        <form method="POST" action="{{ route('expiration-times.store') }}" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                >
                <div class="text-xs text-gray-400 mt-1">The display name (e.g., "1 hour", "1 day", "1 week")</div>
            </div>
            ...
            <div>
                ...
                <input 
                    ...
                    class="w-full bg-gray-900 border border-gray-600 text-white px-4 py-2 text-sm focus:outline-none focus:border-gray-400 rounded"
                >
                <div class="text-xs text-gray-400 mt-1">Number of minutes (e.g., 60 = 1 hour, 1440 = 1 day)</div>
            </div>

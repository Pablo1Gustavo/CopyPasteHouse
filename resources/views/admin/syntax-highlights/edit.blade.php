...
@section('title', 'Edit Syntax Highlight - CopyPasteHouse')

@section('content')
<div class="max-w-2xl mx-auto px-4 py-6">
    <div class="bg-gray-800 rounded-lg p-6">
        <div class="flex justify-between items-center mb-6">
            <h2 class="text-2xl font-bold">Edit Syntax Highlight</h2>
        ...
        <form method="POST" action="{{ route('syntax-highlights.update', $highlight) }}" class="space-y-4">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                >
                <div class="text-xs text-gray-400 mt-1">The technical value for highlight.js</div>
            </div>
